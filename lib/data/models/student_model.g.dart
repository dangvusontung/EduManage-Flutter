...
extension StudentModelQuerySortBy
  ...
  QueryBuilder<StudentModel, StudentModel, QAfterSortBy> sortByDateOfBirth() {
    return QueryBuilder.apply(this, (query) {
...
extension StudentModelQuerySortThenBy
  ...
  QueryBuilder<StudentModel, StudentModel, QAfterSortBy> thenByDateOfBirth() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateOfBirth', Sort.asc);
    });
  }
...
extension StudentModelQueryWhereDistinct
  ...
  QueryBuilder<StudentModel, StudentModel, QDistinct> distinctByDateOfBirth() {
    return QueryBuilder.apply(this, (query) {
...
extension StudentModelQueryProperty
  ...
  QueryBuilder<StudentModel, DateTime?, QQueryOperations>
      dateOfBirthProperty() {
    return QueryBuilder.apply(this, (query) {
