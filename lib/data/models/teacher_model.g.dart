...
extension TeacherModelQueryFilter
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterFilterCondition> nameEqualTo(
    String? value, {
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterFilterCondition> nameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterFilterCondition> nameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TeacherModelQuerySortBy
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterSortBy> sortByDateOfBirth() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<TeacherModel, TeacherModel, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TeacherModelQuerySortThenBy
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterSortBy> thenByDateOfBirth() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateOfBirth', Sort.asc);
    });
  }
  ...
  QueryBuilder<TeacherModel, TeacherModel, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<TeacherModel, TeacherModel, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension TeacherModelQueryWhereDistinct
  ...
  QueryBuilder<TeacherModel, TeacherModel, QDistinct> distinctByDateOfBirth() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dateOfBirth');
    });
  }

  QueryBuilder<TeacherModel, TeacherModel, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TeacherModelQueryProperty
  ...
  QueryBuilder<TeacherModel, DateTime?, QQueryOperations>
      dateOfBirthProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TeacherModel, String?, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
